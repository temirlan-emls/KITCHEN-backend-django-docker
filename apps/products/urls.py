...
urlpatterns = [
    ...
    path('products/random-products/', views.RandomProductsList.as_view()),
    ...
    path('products/<slug:category_slug>/<slug:sub_category_slug>/<slug:product_slug>/', views.ProductDetail.as_view()),
]